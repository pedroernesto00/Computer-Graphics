...
Vec3 eye_dif_material(0.5, 0.5, 0.5);    // Material's difuse component factors
Vec3 eye_spe_material(0.5, 0.2, 0.5);    // Material's specular component factors
...
int main(int argc, char **argv){
    ...
    // cout << body.center.x << ", " << body.center.y << ", " << body.center.z << endl;
